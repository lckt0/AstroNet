using Astro_Renewed.Protections.Arithmetic.Functions;
...
{
    public static class ArithmeticPr
    {
        public static void Execute(ModuleDefMD moduleDef)
        {
            Arithmetic.Arithmetic.Execute(moduleDef);
        }
    }
}
...
namespace Astro_Renewed.Protections.Arithmetic
{
    public static class Arithmetic
    {
        ...
        private static readonly List<Function> Tasks = new List<Function>()
        {
            new Add(),
            new Sub(),
            new Div(),
        ...
        public static void Execute(ModuleDefMD moduleDef)
        {
            ...
            AddMaths.Execute(moduleDef);
            Astro_Renewed.Services.ConsoleLogger.Log("Processing \"Arithmetic\" protection.");
        }
