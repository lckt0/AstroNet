...
namespace KoiVM.RT.Mutation {
	...
	internal class RTMap {
		public static readonly string VMEntry = "Runtime.AstroNet";
		public static readonly string VMRun = "Run";
		public static readonly string VMDispatcher = "Runtime.Execution.VMDispatcher";
		...
		public static readonly string VMConstants = "Runtime.Dynamic.Constants";
